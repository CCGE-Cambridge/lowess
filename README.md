...
<br /> k = Floor((N * bandwidth - 0.5) / 2). 
<br /> The weights for each of the observations between j = i<sub>-</sub>,...,i<sub>+</sub> are the tricube  
<br /> w<sub>j</sub> = [1 - (|x<sub>j</sub> - x<sub>i</sub>| / ∆)<sup>3</sup>]<sup>3</sup> 
<br /> where ∆ = 1.0001 max(x<sub>i<sub>+</sub></sub>-x<sub>i</sub>, x<sub>i</sub>-x<sub>i<sub>-</sub></sub>). 
